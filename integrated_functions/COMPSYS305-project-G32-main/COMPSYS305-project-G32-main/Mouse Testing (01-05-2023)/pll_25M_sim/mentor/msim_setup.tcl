...
# ----------------------------------------
# If pll_25M is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2023.05.01.23:14:28
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_25M.vho"
}
